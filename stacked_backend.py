...
student_discounts = [
    ...
    },
    {
        "merchant": "Nike",
        "category": "Shopping",
        "discount": "Student discount may be available",
        "verification": "Student verification required",
        "type": "in_person"
    },
    {
    ...
    },
    {
        "merchant": "AMC",
        "category": "Entertainment",
        "discount": "Student pricing may be available",
        "verification": "Student ID may be required",
        "type": "in_person"
    }
]
...
async def upload_financial_aid(
    ...
    return {
        ...
        "message":
            "Financial aid document uploaded successfully!",
...
def get_recommendations(latitude: float, longitude: float):
    ...
    if food_spent >= food_budget * 0.80:
